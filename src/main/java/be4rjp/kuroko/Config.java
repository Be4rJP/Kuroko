...
public class Config {
    ...
    private static List<String> loadClasses = new ArrayList<>();
    ...
    public static List<String> getLoadClasses() {return loadClasses;}
    ...
    public static void load(){
        ...
        if(yml.contains("load-class")) loadClasses = yml.getStringList("load-class");
    }
}
